...
const { SplMappingModelAdapter } = require("../../dist/spl/adapters/variamos/SplMappingModelAdapter.js");
const { DerivationResolver } = require("../../dist/spl/DerivationResolver.js");
const { NodeModularMonolithBuilder } = require("../../dist/spl/adapters/builders/NodeModularMonolithBuilder.js");
const { NodeTestAdapter } = require("../../dist/spl/adapters/tests/NodeTestAdapter.js");
const { ArtifactProviderRegistry } = require("../../dist/spl/adapters/providers/ArtifactProvider.js");
const { LocalArtifactProvider } = require("../../dist/spl/adapters/providers/LocalArtifactProvider.js");
